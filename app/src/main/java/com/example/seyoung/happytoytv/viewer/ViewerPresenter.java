...
import com.example.seyoung.happytoytv.rtc_peer.kurento.KurentoViewerRTCClient;
...
public class ViewerPresenter extends MvpBasePresenter<ViewerView>
    ...
    private static final String STREAM_HOST = "wss://13.209.17.1:8444/one2many";
    ...
    public void startCall(String roomid, String roomname) {
        this.roomid = roomid;
        ...
        rtcClient.connectToRoom(STREAM_HOST, roomid,roomname, new BaseSocketCallback() {
            @Override
